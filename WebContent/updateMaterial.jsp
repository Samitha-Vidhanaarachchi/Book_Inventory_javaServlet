...
<%@page import="Servelet.GetIdMaterialServlet"%>
<%@page import="Servelet.UpdateMaterialServlet"%>
...
<br>
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          <li class="nav-item">
                            <a class="nav-link " href="materialView.jsp" role="tab" >
                              <i class="material-icons">local_shipping</i>Material
                            </a>
                          </li>
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" href="updateMaterial.jsp" role="tab" >
        ...
        <div align="center">
        	...
        	Material mat = ( Material ) request.getAttribute("getCid");
		...
		<div class="table-responsive" style="height:410px; width: 850px;">
			<form name="myForm" action="UpdateMaterialServlet" method="post"  onsubmit="return validateForm()">
			<div class="form-group" >
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 class="form-control" name="updateId" placeholder="Material ID..." value="<%=mat.getId()%>" disabled/>
                      </div>
                    </div>
                    <div class="form-group" >
                      <div class="input-group">
                      <input type="hidden"  size="45"
                			 class="form-control" name="updateId" placeholder="Material ID..." value="<%=mat.getId()%>"/>
                      </div>
                    </div>
                      ...
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 class="form-control" placeholder="Material Name..." value="<%=mat.getName()%>" name="updateName"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Stock Limit..." value="<%=mat.getStockLevel()%>"class="form-control" name="updateStock"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Current Stock..." value="<%=mat.getCurrentAmount()%>" class="form-control" name="updateAmount"/>
                      </div>
                    </div>
