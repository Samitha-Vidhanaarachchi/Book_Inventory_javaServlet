...
function validateForm() {
  ...
  int x = document.forms["myForm"]["phone"].value;
...
<br>
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" href="addMaterialPurchase.jsp" role="tab" >
		...
		<div class="table-responsive" style="height:410px; width: 850px;">
			<form name="myForm" action="AddMPurchaseServlet" method="post"  onsubmit="return validateForm()">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 class="form-control" placeholder="Raw material.." name="mName" required/>
                      </div>
                    </div>
                   ...
                   <div class="form-group" >
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 class="form-control" placeholder="Supplier ID.." name="sId" required/>
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Purchased date..." class="form-control" name="pDate" required/>
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Amount(Kg/L)..." class="form-control" name="amount" required/>
                      </div>
                    </div>
           ...
           <div class="card-footer justify-content-center">
            <div class="text-center" >
                     ...
                     <button  type="submit" value="Save"  style="background-color: #99199B; width: 500px;"  class="btn btn-primary" >Add Material Purchase
                     </button>
