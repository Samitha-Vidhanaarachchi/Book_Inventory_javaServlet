<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="Service.MaterialService"%>
<%@page import="Service.MaterialServiceImp"%>
...
<br>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="supplierView.jsp">Supplier Management</a></li>
                     ...
                     <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          <li class="nav-item">
                            <a class="nav-link active " href="materialView.jsp" role="tab" >
                              <i class="material-icons">local_shipping</i>Materials
                            </a>
                          </li>

                          <li class="nav-item">
                            <a class="nav-link" href="addMaterial.jsp" role="tab" >
      ...
      <tr style= "background-color: rgb(150, 70, 150);font-size: 20px; color:white; font-weight:bold;">
       <td style="font-size: 15px; ">Material ID</td> 
        <td style="font-size: 15px; ">Name</td>
        <td style="font-size: 15px;">Stock Limit</td>
        <td style="font-size: 15px;">Initial Amount</td>
      ...
      <%
     	MaterialService iMaterial = new MaterialServiceImp(); 
     	ArrayList<Material> list = iMaterial.listMaterial();
     	
     	for( Material m1 : list){
     %>
     <tbody>
     <tr>
     <td><%=m1.getId()%></td>
        <td><%=m1.getName()%></td>
        <td><%=m1.getStockLevel()%></td>
        <td><%=m1.getCurrentAmount()%></td>
       
        <td>
        	
        
      			  
      			<form action = "GetIdMaterialServlet" method = "post">
                    	<input type="hidden" name="updateId" value="<%=m1.getId() %>">
                    	<input type="hidden" name="updateName" value="<%=m1.getName() %>">
                    	<input type="hidden" name="updateStock" value="<%=m1.getStockLevel() %>">
                    	<input type="hidden" name="updateAmount" value="<%=m1.getCurrentAmount() %>">
       		...
       		<form action="DeleteMaterialServlet" method="post">
                          	 <input type = "hidden" name ="deleteItem" value ="<%=m1.getId()%>">
    ...
    <a href="ReportMaterials.jsp" >  <button type="button" class="btn btn-primary btn-block" style=" width:30%;">Generate report</button></a>
