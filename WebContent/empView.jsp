    ...
    <div class="row">
     <h2>Welcome admin </h2> 
       ...
       <div class="col-lg-6 col-md-8" style="left: 200px;">
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" href="empView.jsp" role="tab" >
                          ...
                          <li class="nav-item">
                           ...
                           <li class="nav-item">
                            <a class="nav-link " href="empEdit" role="tab" >
              ...
              <div class="row" style="  height:500px;">
                    ...
                    <form method="post" action="SearchEmpServlet">
                      <div class="row">
                        <div class="col-lg-8 col-md-6 ">
                          <div class="input-group">
                            ...
                            <input type="text" value="" placeholder="Search..." class="form-control" id="searchEmployee">
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-6 ">
                          <button type="submit" class="btn btn-primary btn-block" id="searchEmpId">Search</button>
                        </div>
                      </div>
                    </form>
        ...
        <div class="card-body" >
          ...
          <div class="table-responsive" style="height:410px; ">
             <table class="table table-hover">
               ...
               <%
                       EmployeeService empsv = new EmployeeServiceImpl();
                    
               			ArrayList<Employee> list = empsv.getAllEmployee();
                    ...
                    %>
                      ...
                      <tr>
                        ...
                        <td class="td-actions text-right">
                        	<form action="GetIdUpdateEmp" method="post">
                        	<input type="hidden" name="updateEmpId"  value="<%=e.getEmpID() %>" >
                        	<input type="hidden" name="updateEmpname"  value="<%=e.getEmpName() %>" >
                        	<input type="hidden" name="updateEmpnic"  value="<%=e.getEmpNIC() %>" >
                        	<input type="hidden" name="updateContact"  value="<%=e.getEmpContact() %>" >
                        	<input type="hidden" name="updateEmail"  value="<%=e.getEmail() %>" >
                        	<input type="hidden" name="updateDesignation"  value="<%=e.getEmpdepartment() %>" >
                        	<input type="hidden" name="updateDepartment"  value="<%=e.getEmpdesignation() %>" >
                        	<input type="hidden" name="updateSalary"  value="<%=e.getSalary() %>" >
							...
							<!-- delete_form  -->
                          	...
                          	<input type="hidden" name="deleteValue" value="<%=e.getEmpID() %>" />
              ...
              <a href="ReportEmployee.jsp" >  <button type="button" class="btn btn-primary btn-block" style=" width:30%;">Generate report</button></a>       
           </div>
