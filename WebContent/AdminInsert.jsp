          ...
          <div class="card card-signup">
            ...
            <div class="col-lg-6 col-md-8" style="left: 200px;">
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" href="AdminInsert.jsp" role="tab" >
           ...
           <div class="col-md-5 col-sm-8" style="position: relative;   ">
              <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="Author" size="45"
                			 placeholder="Author" class="form-control"  required>
                      </div>
                    </div>
                ...
                <div  class="col-lg-5 col-md-6 col-sm-12">			 
                  <select  class="selectpicker " data-style="select-with-transition" title="Choose Category" data-size="7"  name="Category" required>
