...
<nav class="navbar navbar-color-on-scroll navbar-transparent    fixed-top  navbar-expand-lg " color-on-scroll="100" id="sectionsNav">
                      ...
                      <div class="row">
                        <div class="col-lg-8 col-md-6 ">
                          <div class="input-group">
                            ...
                            <input type="text" value="" placeholder="Search..." class="form-control" id="searchCart">
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-6 ">
                          <button type="button" class="btn btn-primary btn-block"  id="searchcartID">Search</button>
                        </div>
                      </div>
                    </form>
      ...
      <div class="card card-plain" >
        <div class="card-body" >
          ...
          <div class="table-responsive" style="height:410px; width: 700px;">
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <%
                        	...
                        	ArrayList <Cart> list = serv.getAllCart();
                      ...
                      <img src="assets/img/B362.jpg" alt="...">
                        ...
                        <td><%=c.getPrice() %></td>
                             ...
                             <td>
                             <form action="GetIdAddPurchase" method="post">
                             <input type="hidden" name="viewBookName" value="<%=c.getBookName() %>">
                             <input type="hidden" name="viewQuantity" value="<%=c.getQty() %>">
                             <input type="hidden" name="viewUnitPrice" value="<%=c.getPrice() %>">
                             
                             <button type="submit"  value="submit" class="btn btn-primary btn-link btn-sm" name="btnPurchase">
                              ...
                              <br>
                               ...
                               <form action="GetIdUpdateCart" method="post">
                                <input type="hidden" name="updateCartId" value="<%=c.getCartId() %>">
                             <input type="hidden" name="updateBookName" value="<%=c.getBookName() %>">
                             <input type="hidden" name="updateAuthor" value="<%=c.getAuthor() %>">
                             <input type="hidden" name="updatePrice" value="<%=c.getPrice() %>">
                             <input type="hidden" name="updateQty" value="<%=c.getQty() %>">
                               <button type="submit"  value="submit" class="btn btn-primary btn-link btn-sm">
                             ...
                             <form action="DeleteCartServlet" method="post">
                          	<input type="hidden" name="deleteValue" value="<%=c.getCartId()%>" />
                          	<button rel="tooltip" class="btn btn-primary btn-link btn-sm" title="Delete" style="color:red;">
           ...
           <a href="ReportCart.jsp" >  <button type="button" class="btn btn-primary btn-block" style=" width:30%;">Generate report</button></a>
        </div>
      </div>
             </div>             
           </div>
  ...
  <script src="assets/js/material-kit.min1036.js?v=2.1.1" type="text/javascript"></script>
     ...
     <script>
    $('#searchcartID').click(function () {
  	  var searchVideo=$('#searchCart').val();
  	  console.log("FFFFFFFFFFFFFFF");
  	 console.log('KKKKKKK'+searchVideo);
  	  $.ajax(
  		        {
  		            type: "post",
  		            url: "http://localhost:8089/Malpiyali_ITP/SearchcartServlet",
