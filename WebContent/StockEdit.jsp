    ...
    <div class="row">
     <h2>Welcome admin </h2> 
        ...
        <div align="center">
        	...
        	Stock st = ( Stock ) request.getAttribute("getOId");
		...
		<div class="table-responsive" style="height:410px; width: 850px;">
			<form name="myForm" action="UpdateStockServlet" method="post"  onsubmit="return validateForm()">
			<div class="form-group" >
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 class="form-control" name="uporderID" placeholder="OrderID..." value="<%=st.getOrderID()%>" disabled/>
                      </div>
                    </div>
                    <div class="form-group" >
                      <div class="input-group">
                      <input type="hidden"  size="45"
                			 class="form-control" name="uporderID" placeholder="OrderID..." value="<%=st.getOrderID()%>"/>
                      </div>
                    </div>
                      ...
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 class="form-control" placeholder="Shop name Name..." value="<%=st.getShopName()%>" name="upshopName"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Address" value="<%=st.getAddress()%>"class="form-control" name="upaddress"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Email..." value="<%=st.getEmail()%>" class="form-control" name="upemail"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Unit price" value="<%=st.getUnitprice()%>" class="form-control" name="upunitprice"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Quantity.." value="<%=st.getQty()%>" class="form-control" name="upqty"/>
                      </div>
                    </div>
           ...
           <div class="card-footer justify-content-center">
            <div class="text-center" >
                     ...
                     <button  type="submit" value="Save"  style="background-color: #99199B; width: 500px;"  class="btn btn-primary" >Update Stock
                     </button>
