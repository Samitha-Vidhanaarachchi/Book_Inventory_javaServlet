...
<%@page import="Model.EmployeeMaleesha"%>
 ...
 <nav class="navbar navbar-color-on-scroll navbar-transparent    fixed-top  navbar-expand-lg " color-on-scroll="100" id="sectionsNav">
          ...
          <div class="card card-signup">
            ...
            <div class="col-lg-6 col-md-8" style="left: 200px;">
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                         ...
                         <li class="nav-item">
                            <a class="nav-link active" href="AssignSalary.jsp" role="tab" >
                      ...
                      <div class="row">
                        <div class="col-lg-8 col-md-6 ">
                          <div class="input-group">
                            ...
                            <input type="text" name="EmployeeId" placeholder="Search..." class="form-control"><input type = "submit" value = "Search" name ="Search" id = "Search">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 ">
                          <!--  <button type="button" class="btn btn-primary btn-block">Search</button>-->
                       			...
                       			<%
                            	EmployeeMaleesha E = (EmployeeMaleesha)request.getAttribute("Employee");
									
                            	if( E != null){
                            	 %>
                            <input type="text" name="EmployeeName" placeholder="Name :" value="<%=E.getEmployeeName()%>">
                            <br><br>
                            <input type="text" name="EmployeeDepartment" placeholder="Department :" value="<%=E.getEmployeeDepartment()%>">
                            <br><br>
                            <input type="text" name="EmployeeRank" placeholder="Position :" value="<%=E.getEmployeeRank()%>">
                            <br><br>
                            <input type="text" name=" BasicSalary" placeholder="Basic Salary:" value="<%=E.getBasicSalary()%>">
          ...
          <div class="table-responsive" style="height:410px; width: 850px;">
            <table class="table table-shopping">
              ...
              <%
              		...
              		ArrayList<EmployeeMaleesha> list = serv.getAllEmployees();
              		
              		for(EmployeeMaleesha s: list){
              %>
                ...
                <tr>  
                  ...
                  <td class="td-name">  </td>    -->
                    ...
                    <td class="td-actions text-right">
                    	<form action="GetAssignSalaryServlet" method="post">                
                    	<input type="hidden" name="employeeID" value="<%=s.getEmployeeId()%>">
                    	<input type="hidden" name="employeeName" value="<%=s.getEmployeeName()%>">
                    	<input type="hidden" name="department" value="<%=s.getEmployeeDepartment()%>">
                    	<input type="hidden" name="position" value="<%=s.getEmployeeRank()%>">
                    	<input type="hidden" name="basicSalary" value="<%=s.getBasicSalary()%>">
                    	<input type="hidden" name="OTRate" value="">
                    	<input type="hidden" name="OTHours" value="">
  ...
  <script src="assets/js/material-kit.min1036.js?v=2.1.1" type="text/javascript"></script>
    ...
    $('#Search').click(function () {
  	  var searchEmployee=$('#searchEmp').val();
  	  console.log("FFFFFFFFFFFFFFF");
  	 console.log('KKKKKKK'+searchEmployee);
  	  $.ajax(
  		        {
  		            type: "post",
  		            url: "http://localhost:8089/SalaryFinal/EmployeeSearchServlet",
