          ...
          <li class="nav-item ">
            ...
            <div class="dropdown-menu dropdown-with-icons">
             ...
             <a href="Category.html" class="dropdown-item">
               ...
               <a href="CategoryC.html" class="dropdown-item">
                <i class="fa fa-book"></i>&nbsp; &nbsp; Children
              </a>
              <a href="CategoryE.html" class="dropdown-item">
            ...
            <div class="col-md-8">
              <div class="card" style="height:700px; width: 700px;">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Complete to purchase</p>
                </div>
                
					   <%
					   		Cart c1 = (Cart) request.getAttribute("getCid");
					   		//Customer c2 = (Customer) request.getAttribute("getC2id");
                  ...
                  <form>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="email" name = "viewFname" class="form-control" value="session" disabled>
                        </div>
                      </div>
                    </div>
                    <br>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name = "viewFname" class="form-control" value="session" disabled>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name = "viewLname" class="form-control" value="session" disabled>
                        </div>
                      </div>
                    </div>
                   <br><br><br><br><br>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="viewBookName" class="form-control" value="<%=c1.getBookName() %>" disabled>
                        </div>
                      </div>                      
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Quantity</label>
                          <input type="text" name="viewQuantity" class="form-control" value="<%=c1.getQty() %>" disabled>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Unit Price</label>
                          <input type="text" name="viewUnitPrice" class="form-control" value="<%=c1.getPrice() %>" disabled>
                        </div>
                      </div>
                    </div>
                <br><br>
