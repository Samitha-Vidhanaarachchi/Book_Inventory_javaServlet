			...
			<form action="UpdateDeliveryServlet" method="post" >
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="updateDelID" size="45"
                			 placeholder="Delivery ID..." value="<%=d1.getDelID() %>" class="form-control"  disabled/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updateDelID" size="45"
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateOrderID" size="45"
                			 placeholder="Order ID..." value="<%=d1.getOrderID() %>" class="form-control" disabled/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updateOrderID" size="45"
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 placeholder="Shop Name..." value="<%=d1.getShopName() %>" class="form-control" name="updateShopName" disabled />
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden"  size="45"
                			 placeholder="Shop Name..." value="<%=d1.getShopName() %>" class="form-control" name="updateShopName" />
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 placeholder="Address..." value="<%=d1.getAddress() %>" class="form-control" name="updateAddress" disabled/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden"  size="45"
                			 placeholder="Address..." value="<%=d1.getAddress() %>" class="form-control" name="updateAddress" />
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 placeholder="Email..." value="<%=d1.getEmail() %>" class="form-control" name="updateEmail" disabled/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                         <input type="hidden"  size="45"
                			 placeholder="Email..." value="<%=d1.getEmail() %>" class="form-control" name="updateEmail" />
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 placeholder="Book ID..." value="<%=d1.getBookID() %>" class="form-control" name="updateBookID" disabled />
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden"  size="45"
                			 placeholder="Book ID..." value="<%=d1.getBookID() %>" class="form-control" name="updateBookID" />
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  size="45" placeholder="Quantity..." value="<%=d1.getQuantity() %>" class="form-control" name="updateQuantity" disabled/>
                			
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden"  size="45" placeholder="Quantity..." value="<%=d1.getQuantity() %>" class="form-control" name="updateQuantity" />
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 placeholder="Amount..." value="<%=d1.getAmount()%>" class="form-control" name="updateAmount" disabled/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden"  size="45"
                			 placeholder="Amount..." value="<%=d1.getAmount()%>" class="form-control" name="updateAmount" />
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                		...
                		<div class="col-lg-50 col-md-60 col-sm-30" size="45">
                              <select class="selectpicker" data-style="select-with-transition" title="<%=d1.getVehicleNo() %>" data-size="7" name="updateVehicle">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <div class="col-lg-50 col-md-60 col-sm-30" size="45">
                              <select class="selectpicker" data-style="select-with-transition" title="<%=d1.getEmpID()%>" data-size="7" name="updateEmployee">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                       ...
                       placeholder="Delivery Date..." value="<%=d1.getDate() %>" class="form-control" name="updateDate"/>
                      </div>
                    </div>
                 ...
                 <div class="text-center" >
                     ...
                     <button  type="submit" value="Save"  style="background-color: #99199B; width: 500px;"  class="btn btn-primary" >Edit Delivery
                     </button>
