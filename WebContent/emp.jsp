          ...
          <div class="card card-signup">
           ...
           <div class="col-lg-6 col-md-8" style="left: 200px;">
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" href="emp.jsp" role="tab" >
		...
		<div class="table-responsive" style="height: 500px;">
			<form action="AddEmpServlet" method="post">
                 ...
                 <div class="form-group">
					...
					<div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="empnic" size="45"
                			 placeholder="Employee NIC No..." class="form-control" />
                      </div>
                    </div>
					...
					<div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="number" name="contact" size="45"
                			 placeholder="Employee Contact..." class="form-control" />
                      </div>
                    </div>
					...
					<div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="number" name="salary" size="45"
                			 placeholder="Basic Salary..." class="form-control" />
                      </div>
                    </div>
                 ...
                 <div class="text-center" >
                     ...
                     <button  type="submit" value="Save"  style="background-color: #99199B; width: 500px;"  class="btn btn-primary" >Add Employee
                     </button>
