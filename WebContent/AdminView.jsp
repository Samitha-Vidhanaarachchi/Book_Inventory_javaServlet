...
<body>
 ...
 <nav class="navbar navbar-color-on-scroll navbar-transparent    fixed-top  navbar-expand-lg " color-on-scroll="100" id="sectionsNav">
  ...
  <div class="page-header header-filter" data-parallax="true" style="  height:1000px; background-image: url('assets/img/bookscover.jpg')">
    <div class="container" >
    <div class="row">
        ...
        <div class="col-md-10 ml-auto mr-auto">
          <div class="card card-signup">
                      ...
                      <div class="row">
                        <div class="col-lg-8 col-md-6 ">
                          <div class="input-group">
                            ...
                            <input type="text" value="" name="SearchBookName" placeholder="Search..." class="form-control" id="searchBooks">
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-6 ">
                          <button type="button" class="btn btn-primary btn-block"  id="searchBookID">Search</button>
                        </div>
                      </div>
                    </form>
                    ...
                    %>
                      ...
                      <img src="assets/BOOKS/MALL/<%=b.getPhoto() %>" alt="...">
                        ...
                        <td><%=b.getBookPrice() %></td>
                             ...
                             <td>
                             <form action="GetIdUpdateBookServlet" method="post">
                             <input type="hidden" name="updateBookphoto" value="<%=b.getPhoto() %>">
                             	<input type="hidden" name="updateBookId" value="<%=b.getBookId() %>">
                             	<input type="hidden" name="updateBookName" value="<%=b.getBookName() %>">
                             	<input type="hidden" name="updateBookAuthor" value="<%=b.getBookauthor() %>">
                             	<input type="hidden" name="updateBookCategory" value="<%=b.getBookCategory() %>">
                             	<input type="hidden" name="updateBookPrice" value="<%=b.getBookPrice() %>">
			...
			<!-- delete_form  -->
                  ...
                  <a href="ReportBooks.jsp" >  <button type="button" class="btn btn-primary btn-block" style=" width:30%;">Generate report</button></a>
  ...
  <script src="assets/js/material-kit.min1036.js?v=2.1.1" type="text/javascript"></script>
        ...
        <script>
    $('#searchBookID').click(function () {
  	  var searchVideo=$('#searchBooks').val();
  	  console.log("FFFFFFFFFFFFFFF");
  	 console.log('KKKKKKK'+searchVideo);
  	  $.ajax(
  		        {
  		            type: "post",
  		            url: "http://localhost:8089/Malpiyali_ITP/SearchBookServlet",
