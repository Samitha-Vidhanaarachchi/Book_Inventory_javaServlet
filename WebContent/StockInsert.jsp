     ...
     <h2>Welcome admin </h2> 
          ...
          <div class="card card-signup">
            ...
            <div class="col-lg-6 col-md-8" style="left: 200px;">
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          <li class="nav-item">
                            <a class="nav-link " href="StockView.jsp" role="tab" >
                              <i class="material-icons">dashboard</i> View Stock
                            </a>
                          </li>

                          <li class="nav-item">
                            <a class="nav-link active" href="StockInsert.jsp" role="tab" >
		...
		<form action="AddStockServlet" method="post">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="shopName" size="45"
                			 placeholder="Shop Name" class="form-control" required />
                      </div>
                    </div>
					<div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="address" size="45"
                			 placeholder="Shop Address" class="form-control" required />
                      </div>
                    </div>
					<div class="form-group">
                      <div class="input-group">
					...
					<div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="bookID" size="45"
                			 placeholder="BookID" class="form-control" required />
                      </div>
                    </div>
					...
					<div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="bookname" size="45"
                			 placeholder="Book Name" class="form-control" required />
                      </div>
                    </div>
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="unitprice" size="45"
                			 placeholder="Unit price" class="form-control" required />
                      </div>
                    </div>
                 ...
                 <div class="text-center" >
                     ...
                     <button  type="submit" name="Save" value="Save" onclick="validateForm()"  style="background-color: #99199B; width: 500px;"  class="btn btn-primary" >Add Books
                     </button>
                     <button  style="background-color: red; width: 200px;"  type="reset" value="Reset" onclick="nomsg()" class="btn btn-primary" >Clear
                   ...
                   function validateForm() {
   					var x = document.forms["form"]["shopName"].value;
   					var y = document.forms["form"]["address"].value;
   					var z = document.forms["form"]["email"].value;
   					var a = document.forms["form"]["bookID"].value;
   					var b = document.forms["form"]["bookname"].value;
   					var c = document.forms["form"]["unitprice"].value;
   					var d = document.forms["form"]["qty"].value;
