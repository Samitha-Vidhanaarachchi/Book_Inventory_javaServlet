          ...
          <div class="card card-signup">
            ...
            <div class="col-lg-6 col-md-8" style="left: 200px;">
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          <li class="nav-item">
                            <a class="nav-link " href="AdminView.jsp" role="tab" >
                              <i class="material-icons">dashboard</i> Book
                            </a>
                          </li>
                          ...
                          <li class="nav-item">
                           ...
                           <li class="nav-item">
                            <a class="nav-link active" href="AdminEdit.jsp" role="tab" >
              ...
              <div class="profile-content">
        		...
        		<%
        			Books b1 = (Books) request.getAttribute("getCid");
        			if(b1 != null){        		
           ...
           <div class="col-md-5 col-sm-8" style="position: relative;   ">
              <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                <div class="fileinput-new thumbnail img-raised"  style="height: 150px; width: 150px; left: 150px;">
                   <img src="assets/BOOKS/MALL/<%=b1.getPhoto() %>" alt="..." >
                ...
                <div>
                  <span class="btn btn-raised btn-round btn-default btn-file">
                    ...
                    <input type="file" name="updateBookPhoto" size ="50" />
                  </span>
                  <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
     				...
     				<div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateBookID" size="45"
                			 class="form-control" placeholder="Book ID..."  value="<%=b1.getBookId() %>" disabled>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updateBookID" size="45"
                			 class="form-control" placeholder="Book ID..."  value="<%=b1.getBookId() %>" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateBookName" size="45"
                			 class="form-control" placeholder="Book Name..."  value="<%=b1.getBookName() %>"required>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateBookAuthor" size="45"
                			 placeholder="Author" class="form-control" value="<%=b1.getBookauthor() %>" required/>
                      </div>
                    </div>
                         <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateBookCategory" size="45"
                			 placeholder="Category" class="form-control" value="<%=b1.getBookCategory() %>" />
                      </div>
                    </div>
                         <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateBookPrice" size="45"
                			 placeholder="Price" class="form-control" value="<%=b1.getBookPrice() %>" required/>
                      </div>
                    </div>
                     ...
                     <button  type="submit" value="Save"  style="background-color: #99199B; width: 500px;"  class="btn btn-primary" >Edit Books
                     </button>
                     
                     <button type="reset"  style="background-color: red; width: 200px;"  type="button" class="btn btn-primary" onclick="return nomsg()">Clear
                     </button>
                    </div>
