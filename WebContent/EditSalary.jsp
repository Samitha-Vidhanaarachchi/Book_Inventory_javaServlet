        ...
        <div class="col-md-10 ml-auto mr-auto">
          <div class="card card-signup">
            ...
            <div class="col-lg-6 col-md-8" style="left: 200px;">
                          ...
                          <li class="nav-item">
                            <a class="nav-link " href="ViewSalary.jsp" role="tab" >
                          ...
                          <li class="nav-item">
                           ...
                           <li class="nav-item">`
                            <a class="nav-link active" href="EditSalary.jsp" role="tab" >
             ...
             <div align="center">
		<%
			salary s1 = (salary) request.getAttribute("getCid");
			...
			<form action="UpdateSalaryServlet" method="post" >
                    ...
                    <div class="form-group" >
                      <div class="input-group">
                        ...
                        <input type="text" name="updateEmpID" size="45"
                			 class="form-control" placeholder="Employee ID..." value="<%=s1.getEmployeeId()%>" disabled>
                      </div>
                    </div>
                    <div class="form-group" >
                      <div class="input-group">                        
                        <input type="hidden" name="updateEmpID" size="45"
                			 class="form-control" placeholder="Employee ID..." value="<%=s1.getEmployeeId()%>">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateEmpName" size="45"
                			 placeholder="Name..." class="form-control" value="<%=s1.getEmployeeName()%>" disabled/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updateEmpName" size="45"
                			 placeholder="Name..." class="form-control" value="<%=s1.getEmployeeName()%>"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateDept" size="45"
                			 placeholder="Department..." class="form-control" value="<%=s1.getEmployeeDepartment()%>" disabled/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updateDept" size="45"
                			 placeholder="Department..." class="form-control" value="<%=s1.getEmployeeDepartment()%>"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateRank" size="45"
                			 placeholder="Designation..." class="form-control" value="<%=s1.getEmployeeRank()%>" disabled/>
                      </div>
                    </div> 
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updateRank" size="45"
                			 placeholder="Designation..." class="form-control" value="<%=s1.getEmployeeRank()%>"/>
                      </div>
                    </div> 
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateBasicSal" size="45"
                			 placeholder="Basic Salary..." class="form-control" value="<%=s1.getBasicSalary()%>" disabled/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updateBasicSal" size="45"
                			 placeholder="Basic Salary..." class="form-control" value="<%=s1.getBasicSalary()%>" />
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateOTRate" size="45"
                			 placeholder="OT Rate..." class="form-control" value="<%=s1.getOTRate()%>"/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="updateOTHours" size="45"
                			 placeholder="OT Hours..." class="form-control" value="<%=s1.getOTHours()%>"/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                     ...
                     <input type="text" name="updateNetSal" size="45"
                			 placeholder="Net Sal..." class="form-control" value="<%=s1.getNetSalary()%>" disabled/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updateNetSal" size="45"
                			 placeholder="Net Salary..." class="form-control" value="<%=s1.getNetSalary()%>" />
                      </div>
                    </div>
                 ...
                 <div class="text-center" >
                     ...
                     <button  type="submit" value="Save"  style="background-color: #99199B; width: 500px;"  class="btn btn-primary" >Edit
                     </button>
