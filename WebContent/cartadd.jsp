      ...
      <div class="modal-content">
        ...
        <div class="form-group">
                  <div class="input-group">
                   ...
                   <input type="text" class="form-control" value="<%=c1.getBookName() %>" name = "bookName" />
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="<%=c1.getAuthor() %>" name = "bookAuthor" >
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                   ...
                   <input type="text" class="form-control" value="<%=c1.getPrice()%>" name = "bookPrice" >
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
