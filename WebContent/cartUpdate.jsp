...
<nav class="navbar navbar-color-on-scroll navbar-transparent    fixed-top  navbar-expand-lg " color-on-scroll="100" id="sectionsNav">
  ...
  <div class="page-header header-filter" data-parallax="true" style="  height:400px; background-image: url('assets/img/bookscover.jpg')">
    <div class="container" >
    <div class="row">
     <h2>Welcome User </h2> 
    ...
    <div class="modal-dialog modal-notice" role="document" style=" top: 40px; left:18px; width:500px;">
      <div class="modal-content">
        <div class="modal-header">
         <center><b><h4 style="color:black;">Do you want to add this book to cart?</h4></b></center>
        </div>
        
         <%
        	Cart c1 = (Cart) request.getAttribute("getCid");
        ...
        <div class="modal-body">
               ...
               <div class="input-group">
                   <input type="hidden" name="updateCartId" 
                			  value="<%=c1.getCartId() %>" class="form-control"  />
                  </div>
                </div>        
        		...
        		<div class="form-group">
                  <div class="input-group">
                   ...
                   <input type="text" name="updateBookName" 
                			  value="<%=c1.getBookName() %>" class="form-control"  disabled/>
                  </div>
                </div>
                <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updateBookName" 
                			 value="<%=c1.getBookName() %>" class="form-control"  />
                      </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="text" name="updateAuthor" 
                			  value="<%=c1.getAuthor() %>" class="form-control"  disabled/>
                  </div>
                </div>
                <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updateBookName" 
                			 value="<%=c1.getAuthor() %>" class="form-control"  />
                      </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                   ...
                   <input type="text" name="updatePrice" 
                			  value="<%=c1.getPrice() %>" class="form-control"  disabled/>
                  </div>
                </div>
                <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="updatePrice" 
                			 value="<%=c1.getPrice() %>" class="form-control"  />
                      </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="text" name="updateQty" 
                			  value="<%=c1.getQty() %>" class="form-control" />
                  </div>
                </div>
        ...
        <div class="modal-footer text-center">
 					...
 					<button  type="submit" value="Save"  style="background-color: #99199B; width: 500px;"  class="btn btn-primary" >Update
                     </button>
        </div>
