     ...
     <h2>Welcome admin </h2> 
          ...
          <div class="card card-signup">
            ...
            <div class="col-lg-6 col-md-8" style="left: 200px;">
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" href="InsertSalary.jsp" role="tab" >
		...
		<div class="table-responsive" style="height:410px; width: 850px;">
     		...
     		<form action="InsertServlet" method="post">
                    ...
                    <div class="form-group" >
                      <div class="input-group">                        
                        <input type="hidden" name="EmployeeId" size="45"
                    ...
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="EmployeeName" size="45"
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="EmployeeDepartment" size="45"
                			 placeholder="Department" class="form-control" value="<%=s1.getEmployeeDepartment() %>" disabled/>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">                      
                        <input type="hidden" name="EmployeeDepartment" size="45"
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="EmployeeRank" size="45"
                			 placeholder="Position..." class="form-control" value="<%= s1.getEmployeeRank() %>" disabled/>
                      </div>
                    </div> 
                    <div class="form-group">
                      <div class="input-group">
                         <input type="hidden" name="EmployeeRank" size="45"
                			 placeholder="Position..." class="form-control" value="<%= s1.getEmployeeRank() %>"/>
                      </div>
                    </div>  
                    ...
                    <div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="BasicSalary" size="45"
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="OTRate" size="45"
                			 placeholder="OT Rate..." class="form-control" />
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" name="OTHours" size="45"
                			 placeholder="OT Hours..." class="form-control"  />
                      </div>
                    </div>
                    <!--<div class="form-group">
                      <div class="input-group">                        
                        <input type="hidden" name="NetSalary" size="45"
                			 placeholder="OT Hours..." class="form-control"  />
                      </div>
                    </div>  -->
                 ...
                 <div class="text-center" >
                     ...
                     <button  type="submit" value="Save"  style="background-color: #99199B; width: 500px;"  class="btn btn-primary" >Calculate
                     </button>
                </div>
