...
function validateForm() {
	...
	var x = document.forms["myForm"]["conCode"].value;
  var x = document.forms["myForm"]["material"].value;
  var x = document.forms["myForm"]["startDate"].value;
  var x = document.forms["myForm"]["endtDate"].value;
  var x = document.forms["myForm"]["phone"].value;
  var x = document.forms["myForm"]["email"].value;
  var x = document.forms["myForm"]["address"].value;
  if (x == "") {
    alert("All the feilds filled out");
    return false;
  }
}
</script>
...
<br>
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" href="addSupplier.jsp" role="tab" >
		...
		<div class="table-responsive" style="height:410px; width: 850px;">
			<form name="myForm" action="AddSupplierSevlet" action="/action_page.php" method="post"  onsubmit="return validateForm()" >
                      ...
                      <div class="input-group"> 
                        ...
                        <input type="text"  size="45"
                			 class="form-control" placeholder="Supplier Name..." name="sName" required/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Contract Code..." class="form-control" name="ConCode" required/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Material Supplied..." class="form-control" name="material" required/>
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Contract Start Date..." class="form-control" name="startDate" required/>
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 placeholder="Contract End Date..." class="form-control" name="endDate" required/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 placeholder="Contact Number..." class="form-control" name="phone" required/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="email" size="45"
                			 placeholder="Email..." class="form-control" name="email" required/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Address..." class="form-control" name="address" required/>
                      </div>
                    </div>
           ...
           <div class="card-footer justify-content-center">
            <div class="text-center" >
                     ...
                     <button  type="submit" value="Submit"  style="background-color: #99199B; width: 500px;"  class="btn btn-primary" >Add Supplier
                     </button>
