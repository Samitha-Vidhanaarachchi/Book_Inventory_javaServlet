...
<%@page import="Servelet.GetIdmPurchaseServlet"%>
<%@page import="Servelet.UpdatemPurchaseServlet"%>
<%@page import="java.util.ArrayList" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>

  <title>Update MPurchase</title>
...
<br>
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          <li class="nav-item">
                            <a class="nav-link " href="materialPurchaseView.jsp" role="tab" >
                              <i class="material-icons">local_shipping</i>Material Purchase
                            </a>
                          </li>
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" href="updateMPurchase.jsp" role="tab" >
        ...
        <div align="center">
				  ...
				  MaterialPurchase sup = ( MaterialPurchase) request.getAttribute("getCid");
		...
		<div class="table-responsive" style="height:410px; width: 850px;">
			<form name="myForm" action="UpdatemPurchaseServlet" method="post"  onsubmit="return validateForm()">
			<div class="form-group" >
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 class="form-control" name="updateId" placeholder="Purchase ID..." value="<%=sup.getId()%>" disabled/>
                      </div>
                    </div>
                    <div class="form-group" >
                      <div class="input-group">
                      <input type="hidden"  size="45"
                			 class="form-control" name="updateId" placeholder="Purchase ID..." value="<%=sup.getId()%>"/>
                      </div>
                    </div>
                      ...
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 class="form-control" placeholder="Material Name..." value="<%=sup.getmName()%>" name="updateName"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Supplier ID..." value="<%=sup.getsId()%>"class="form-control" name="updateSid"/>
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" size="45"
                			 placeholder="Purchased Date..." value="<%=sup.getDate()%>" class="form-control" name="updateDate"/>
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text"  size="45"
                			 placeholder="Contract End Date..."  value="<%=sup.getAmount()%>" class="form-control" name="updateAmount" />
                      </div>
                    </div>
