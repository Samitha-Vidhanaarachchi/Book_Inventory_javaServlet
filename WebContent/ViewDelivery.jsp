...
<body>
 ...
 <nav class="navbar navbar-color-on-scroll navbar-transparent    fixed-top  navbar-expand-lg " color-on-scroll="100" id="sectionsNav">
          ...
          <div class="card card-signup">
            ...
            <div class="col-lg-16 col-md-18" style="left: 200px;">
                      <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">                        
                          <li class="nav-item">
                            <a class="nav-link active" href="ViewDelivery.jsp" role="tab" >
                      ...
                      <div class="row">
                        <div class="col-lg-8 col-md-6 ">
                          <div class="input-group">
                            ...
                            <input type="text" name="searchDelivery" placeholder="Search..." class="form-control" id="searchDelivery">                           
                          </div>
                        </div>
        ...
        <div class="card-body" >
          ...
          <div class="table-responsive" style="height:410px; width: 1070px;">
            <table class="table table-shopping">
                ...
                <tr>            
                  ...
                  <td class="td-name">  <%=s.getDate() %></td> 
                    ...
                    <td class="td-actions text-right">
                    	<form action="GetIdUpdateDelivery" method="post">
                    	<input type="hidden" name="updateDelID" value="<%=s.getDelID() %>">
                    	<input type="hidden" name="updateOrderID" value="<%=s.getOrderID() %>">
                    	<input type="hidden" name="updateShopName" value="<%=s.getShopName()%>">
                    	<input type="hidden" name="updateAddress" value="<%=s.getAddress() %>">
                    	<input type="hidden" name="updateEmail" value="<%=s.getEmail() %>">
                    	<input type="hidden" name="updateBookID" value="<%=s.getBookID() %>">
                    	<input type="hidden" name="updateQuantity" value="<%=s.getQuantity() %>">
                    	<input type="hidden" name="updateAmount" value="<%=s.getAmount() %>">
                    	<input type="hidden" name="updateVehicle" value="<%=s.getVehicleNo()%>">
                    	<input type="hidden" name="updateEmployee" value="<%=s.getEmpID()%>">
                    	<input type="hidden" name="updateDate" value="<%=s.getDate() %>">
             ...
             <a href="ReportDelivery.jsp" >  <button type="button" class="btn btn-primary btn-block" style=" width:30%;">Generate report</button></a>
  ...
  <script>
    $('#searchDeliveryID').click(function () {
      var searchVideo=$('#searchDelivery').val();
      console.log("FFFFFFFFFFFFFFF");
     console.log('KKKKKKK'+searchDelivery);
      $.ajax(
              {
                  type: "post",
                  url: "http://localhost:8089/Malpiyali/SearchDeliveryServlet",
